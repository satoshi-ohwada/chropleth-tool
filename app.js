...
(function () {
  ...
  const PALETTES = {
    ...
    blues: ["#eff6ff", "#bfdbfe", "#60a5fa", "#2563eb", "#1e40af", "#172554"],
    greens: ["#f0fdf4", "#bbf7d0", "#4ade80", "#16a34a", "#15803d", "#052e16"],
    oranges: ["#fff7ed", "#fed7aa", "#fb923c", "#ea580c", "#c2410c", "#431407"],
    reds: ["#fef2f2", "#fca5a5", "#ef4444", "#dc2626", "#991b1b", "#450a0a"],
    purples: ["#faf5ff", "#e9d5ff", "#c084fc", "#9333ea", "#6b21a8", "#3b0764"],
